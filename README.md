...
Gameplay & Mechanics:
Sequential Boss Progression: Progress through bosses in order. Defeat Frank S first, locate his key item in the library, unlock the next chamber, and face the Mummy before advancing toward Lady Dracula and the final showdown.

Exploration & Item Management: 
Search various locations and rooms to acquire the specific key items needed to unlock restricted areas.
